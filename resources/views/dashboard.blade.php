...
@section('content')
    ...
    <div x-data="$store.create" class="relative h-[100vh] w-full">
            <!-- Sidebar -->
            <div class="absolute left-[3%] top-[5%] bottom-0 flex flex-col w-[90%]" x-show="!loading">
                ...
                <ul class="flex flex-col h-full px-4 justify-evenly w-fit">
                    <li><button type="button" x-on:click.prevent=" tab = 'kalkulator', localStorage.setItem('tab', 'kalkulator')"
                        class="absolute pl-1 text-4xl lg:static text-dark lg:text-white left-24 top-1"><i x-bind:class="tab == 'kalkulator' ? 'text-red-400' : 'text-gray-400'" class="fa-solid fa-qrcode"></i></button>
                    </li>
                    <li><button type="button" x-on:click.prevent=" tab = 'listHitungan', localStorage.setItem('tab', 'listHitungan')"
                        class="absolute pl-1 text-4xl lg:static text-dark lg:text-white left-44 top-1"><i x-bind:class="tab == 'listHitungan' ? 'text-red-400' : 'text-gray-400'" class="fa-solid fa-money-bill"></i></button>
                    </li>
                    <li><button type="button" x-on:click.prevent=" tab = 'profile', localStorage.setItem('tab', 'profile')"
                        class="absolute pl-1 text-4xl lg:static text-dark lg:text-white left-64 top-1"><i x-bind:class="tab == 'profile' ? 'text-red-400' : 'text-gray-400'" class="fa-regular fa-user"></i></button>
                    </li>
