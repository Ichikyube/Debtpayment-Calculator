@props(['monthlySalary' => 'monthlySalary', 'extraPayment' => 'extraPayment'])
...
<div class="bg-[#F7D3C2] w-11/12 hidden md:block lg:block h-fit md:ml-4 lg:ml-4 rounded-md lg:rounded-[15px] shadow-sm hover:shadow-md transition-shadow duration-300 ease-in-out">
    ...
    <div class="flex flex-row flex-wrap w-full lg:flex-col">
         <!-- Monthly Salary -->
        <div class="flex flex-row items-center justify-between w-full px-3 py-4 border-b-2 group">
            ...
            <div class="relative flex items-center justify-between w-full">
                <input x-model="{{$monthlySalary}}" id="monthlySalary" class="monthlySalary text-transparent bg-transparent focus:text-black/30 form-input z-10 peer block w-full appearance-none px-3 pt-2 placeholder:!bg-transparent transition duration-150 ease-in-out align-text-bottom sm:text-md sm:leading-1 focus:border-none focus:outline-none border-0 text-left outline-none focus-visible:ring-0" type="number" min="0" step="100" placeholder=" ">
        ...
        <div class="flex flex-row items-center justify-between w-full px-3 py-4 group">
            ...
            <div class="relative flex items-center justify-between w-full">
                <input x-model="{{$extraPayment}}" class="extraPayment text-transparent bg-transparent focus:text-black/30 form-input z-10 peer block w-full appearance-none px-3 pt-2 placeholder:!bg-transparent transition duration-150 ease-in-out align-text-bottom sm:text-md sm:leading-1 focus:border-none focus:outline-none border-0 text-left outline-none focus-visible:ring-0" type="number" min="0" step="100" placeholder=" ">
            ...
            <div x-show="extraPayment" class="absolute right-0 w-10/12 mr-4 font-bold text-right truncate" x-money.en-US.USD.decimal="extraPayment"></div>
        </div>
    </div>
</div>
