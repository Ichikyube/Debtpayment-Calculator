<div id="hilanginscroll" x-data="{modelOpen: false }" x-init="listData()">
    ...
    <div x-show="modelOpen" class="absolute top-1/2 left-1/2" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div x-data="{ open: false, delete1: false}" class="bg-[#F7D3C2] py-[24px] px-[45px] rounded-[30px] mt-5">
        ...
        <div class="flex justify-between">
            <p class="text-xl font-semibold text-gray-800 w-96 inline-block truncate">
