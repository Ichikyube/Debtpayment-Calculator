<div x-data="$store.create">
    ...
    <div x-show="!calculated" class="relative flex justify-evenly">
        <div class="flex flex-col w-1/2 px-4 overflow-y-scroll h-[450px] touch-auto hilanginscroll">
            <!-- Form Kalkulator -->
        ...
        <div class="flex flex-col items-center mb-2 align-middle lg:w-1/3">
            <div class="bg-[#F7D3C2] h-fit ml-4 rounded-md lg:rounded-[30px] shadow-sm hover:shadow-md transition-shadow duration-300 ease-in-out">
                <div class="flex flex-row px-5 py-5 align-middle border-b-2">
                ...
                <div class="flex items-center justify-between px-3 py-3">
                    ...
                    <div class="items-center justify-between inline w-full">
            ...
            <div x-show="!calculated" class="flex items-center px-3 pt-4 text-center justify-evenly">
