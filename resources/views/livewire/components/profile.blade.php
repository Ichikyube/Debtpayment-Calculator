<div>
    <div class="container mx-auto" x-data="$store.userProfile">
        ...
        <div class="flex flex-col w-full lg:flex-row mt-14" x-init="userData(), getProfile()">
            <div class="px-8 lg:flex-row lg:w-1/2">
                <div class="flex flex-col justify-center -mt-8">
                    ...
                    <div class="mt-12 text-center">
                        <h3 class="mb-2 text-4xl font-semibold leading-normal text-blueGray-700" x-text="user.name">
                        </h3>
