<div class="container mx-auto" x-init="getProfile()">
    
    <script src="{{asset('js/users/profile.js')}}"></script>

    <h1 class="my-4 ml-8 text-3xl font-bold lg:my-0 lg:mb-4">profile</h1>
    <div class="flex flex-col w-full lg:flex-row mt-14" x-data="$store.userProfile">
            ...
            <div class="border-t border-gray-200">
                <div class="flex flex-row items-center px-4 py-5 border-b-2">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <input x-model="user.name" type="text" class="mt-1 text-sm text-gray-400 sm:col-span-2 sm:mt-0 form-input appearance-none block px-3 border-0
                ...
                {{-- <div class="flex flex-row items-center px-4 py-5 border-b-2">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        ease-in-out sm:text-sm sm:leading-5focus:border-none focus:outline-none focus-visible:ring-0">
                    </div>
                </div> --}}
                ...
                <div class="flex flex-row items-center px-4 py-5 border-b-2">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <input x-model="user.tempat_lahir" type="text" class="form-input appearance-none block px-3 border-0 rounded-xl outline-none
                        placeholder:!bg-transparent bg-transparent transition duration-150 ease-in-out sm:text-sm sm:leading-5
                        focus:border-none focus:outline-none focus-visible:ring-0
                        mt-1 text-sm text-gray-400 sm:col-span-2 sm:mt-0">
                    </div>
                ...
                <div class="flex flex-row items-center px-4 py-5 border-b-2">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <input x-model="user.tgl_lahir" type="text" class="form-input appearance-none block px-3 border-0 rounded-xl outline-none
                        placeholder:!bg-transparent bg-transparent transition duration-150 ease-in-out sm:text-sm sm:leading-5
                        focus:border-none focus:outline-none focus-visible:ring-0
                        mt-1 text-sm text-gray-400 sm:col-span-2 sm:mt-0">
                    </div>
                ...
                <div class="flex flex-row items-center px-4 py-5 border-b-2">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <input x-model="user.alamat" type="text" class="form-input appearance-none block px-3 border-0 rounded-xl outline-none
                        placeholder:!bg-transparent bg-transparent transition duration-150 ease-in-out sm:text-sm sm:leading-5
                        focus:border-none focus:outline-none focus-visible:ring-0
                        mt-1 text-sm text-gray-400 sm:col-span-2 sm:mt-0">
                    </div>
