            ...
            <div class="flex flex-col justify-center -mt-8 lg:w-max">
                ...
                <div class="mt-6 text-center">
                    ...
                    <ul class="max-w-xl p-2 mx-auto mt-5 overflow-y-scroll text-justify transition-colors duration-1000 ease-in-out max-h-44 md:w-1/2 lg:w-full group hover:border hover:border-sky-500/30 hilanginscroll overflow-clip text-blueGray-600">
                        ...
                        <li class="transition-colors duration-1000 ease-in-out border-transparent group-hover:border-b group-hover:border-sky-500/30"><p class="break-normal whitespace-normal"><b> Tempat, Tgl Lahir  </b> <span> : </span> <span x-text="user.tempat_lahir" ></span><span>, </span><span x-text="formatTglFull(user.tgl_lahir)"></span> </p></li>
