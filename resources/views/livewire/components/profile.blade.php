<div class="container" x-data="$store.userProfile">
    ...
    <div x-show="showErrorAlert"
        ...
        class="absolute z-30 w-[700px] right-1/2 left-1/4 -top-5 p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
    ...
    <div x-show="showSuccessAlert"
        ...
        <div class="flex items-center">
            ...
            <div class="flex flex-col">
                <span class="font-medium text-xl">Success</span>
