            ...
            <div x-data="$store.login" class="font-normal">
                <div class="tracking-[4.03px] text-dark">
                    <a href="{{ route('home') }}">
                        ...
                        <h2 class="hidden text-[40px] leading-relaxed text-center md:block">
                            Debt Repayment
                        </h2>
                    </a>
                </div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 rounded-md">
                                    <input x-model="email" type="email" name="email" id="email" required autofocus
                                        class="form-input appearance-none block w-full px-3 py-2 border-0 border-b border-b-2 border-b-white border-b-solid outline-none placeholder:!bg-transparent bg-transparent
                            ...
                            <p class="mt-2 text-sm leading-5 text-center text-gray-600 max-w">
                                ...
                                <a href="{{ route('register') }}"
                                    class="font-medium transition duration-150 ease-in-out hover:text-indigo-500 focus:outline-none focus:underline">
